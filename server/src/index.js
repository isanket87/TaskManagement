...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            imgSrc:     ["'self'", 'data:', 'https:', 'blob:', "https://res.cloudinary.com", "https://*.google-analytics.com", "https://*.analytics.google.com"],
            connectSrc: ["'self'", 'wss:', 'https:', "https://*.google-analytics.com", "https://*.analytics.google.com", "https://*.googletagmanager.com"],
